...
if (isset($err) && $err!=""){
	...
	header("Location: https://ec2-18-117-218-14.us-east-2.compute.amazonaws.com/hw16/index.php?page=contact&err=$err", true, 301);
}
...
header("Location: https://ec2-18-117-218-14.us-east-2.compute.amazonaws.com/hw16/index.php?page=contact", true, 301);
}
